...
let
    ...
    persist-list = [
        ...
        [osConfig.programs.coolercontrol.enable [] [".config/org.coolercontrol.CoolerControl"]]
        ...
        [osConfig.services.wivrn.enable [] [".config/wivrn"]]
